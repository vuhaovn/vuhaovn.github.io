;(function($){
	...
	// 	folder += '<div class="item" data-type="folder"><span class="icon_close">css</span><div class="btn_option">&#9679;&#9679;&#9679;</div></div>';
	// 	folder += '</div>';

	// var
	// 	file = '<div class="sub_item">';
	// 	file += '<div class="item" data-type="file"><span class="icon_file">index.html</span><div class="btn_option">&#9679;&#9679;&#9679;</div></div>';
	// 	file += '</div>';
